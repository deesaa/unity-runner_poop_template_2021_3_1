...
public static class EcsFilterExt
{
    ...
    public static bool TryGetLinkOf<T, T1>(this EcsFilter<MonoLinkComponent<T>, T1> filter, GameObject go, out EcsEntity entity)  
        where T : ILinkable
        where T1 : struct
    {
        foreach (int i in filter)
    ...
    public static bool TryGetLinkOf<T, T1, T2>(this EcsFilter<MonoLinkComponent<T>, T1, T2> filter, GameObject go, out EcsEntity entity)  
        where T : ILinkable
        where T1 : struct 
        where T2 : struct
    {
    ...
    public static bool TryGetLinkOf<T, T1, T2, T3>(this EcsFilter<MonoLinkComponent<T>, T1, T2, T3> filter, GameObject go, out EcsEntity entity)  
        where T : ILinkable
        where T1 : struct 
        where T2 : struct 
        where T3 : struct
    ...
    public static bool TryGetChildrenOf<T, T1>(this EcsFilter<OwnerComponent, T>.Exclude<T1> filter, EcsEntity parentEntity, in List<EcsEntity> childEntities)
        where T : struct
        where T1 : struct
    {
        
        if (!parentEntity.Has<UIdComponent>())
        {
            return false;
        }
    ...
    public static bool TryGetChildrenOf<T, T1, T3>(this EcsFilter<OwnerComponent, T, T1>.Exclude<T3> filter, EcsEntity parentEntity, in List<EcsEntity> childEntities)
        where T : struct
        where T1 : struct
        where T3 : struct
    {
